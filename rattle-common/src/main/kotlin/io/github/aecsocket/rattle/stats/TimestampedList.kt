...
class TimestampedListImpl<T> internal constructor(override var buffer: Long) :
    MutableTimestampedList<T> {
...
fun <T> TimestampedList(buffer: Long): MutableTimestampedList<T> = TimestampedListImpl(buffer)
